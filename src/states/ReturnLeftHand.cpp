#include "ReturnLeftHand.h"
#include "../JRLTask.h"
#include <mc_rtc/ConfigurationHelpers.h>

void ReturnLeftHand::start(mc_control::fsm::Controller & ctl) {
...
bool ReturnLeftHand::run(mc_control::fsm::Controller & ctl) {
...
void ReturnLeftHand::teardown(mc_control::fsm::Controller & ctl_)
{
	...
	mc_rtc::log::info("[ReturnLeftHand] teardown complete");
}

EXPORT_SINGLE_STATE("ReturnLeftHand", ReturnLeftHand)
